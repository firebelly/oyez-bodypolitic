      ...
      <ul class="resources-list corresponding-list">
        ...
        <li id="general-people">
          ...
          <ul class="sub-category">
            ...
            <li>
              <p><a href="http://liveactionnews.org/7-things-didnt-know-jane-roe-roe-v-wade/" target="_blank">7 things you didn’t know about Jane Roe of Roe v. Wade</a>, <em>Live Action News</em></p>
            </li>
            <li>
