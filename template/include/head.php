...
<!--[if gt IE 9]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
  <head>
    ...
    <!--[if lt IE 9]>
      <script src="template/js/no-build/respond.min.js"></script>
      <script src="template/js/no-build/svg4everybody.min.js"></script>
    <![endif]-->
    <script src="template/js/no-build/modernizr.custom.js"></script>
    <script>
      (function(d) {
        var config = {
          kitId: 'tnm6msr',
