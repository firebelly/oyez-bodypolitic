  ...
  <div class="sceneElement" data-viewport="0">
    ...
    <div class="page-content">
      ...
      <section id="ch1-7">
        ...
        <p>At the time, the Court was considered more liberal than it is today, but was beginning a transition towards leaning more conservative. It is important to note, however, that when Roe was argued, abortion had not yet become the divisive issue along party lines that it is today.</p>
      </section>
      ...
      <section id="ch1-11">
        ...
        <div class="aside-wrap">
          <p>The Supreme Court heard many challenges related to Roe v. Wade, starting just a few years after the decision came down. These included <span class="aside-trigger first-item" data-aside="planned-parenthood-v-danforth"><span class="notice-me"><svg class="icon icon-info"><use xlink:href="#icon-info"></use></svg></span>Planned Parenthood v. Danforth</span> (1976), <span class="aside-trigger first-item" data-aside="akron-v-akron"><span class="notice-me"><svg class="icon icon-info"><use xlink:href="#icon-info"></use></svg></span>City of Akron v. Akron Center for Reproductive Health</span> (1983), and <span class="aside-trigger first-item force-wrap" data-aside="thornberg-v-acog"><span class="notice-me"><svg class="icon icon-info"><use xlink:href="#icon-info"></use></svg></span>Thornberg v. American College of Obstetricians and Gynecologists</span> (1986).</p>
