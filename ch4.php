...
<div class="wrap">
  <div class="sceneElement" data-viewport="3">
    ...
    <div class="page-content">
      ...
      <section id="ch4-5">
        ...
        <div class="aside-wrap">
          ...
          <aside class="aside-container aside_audio inactive" data-aside="oral-argument-1">
            ...
            <blockquote><p>“The American Medical Association and every other mainstream leading medical association to consider these requirements has -- has concluded that they are not medically justified for a variety of reasons, including that they impose these onerous burdens on medical abortion, which is the earliest form of abortion, and that these burdens are also imposed on early surgical abortion, procedures prior to 16 weeks. And as a result, women are going to be delayed later in pregnancy. And there is evidence in the record that following implementation of the admitting-privileges requirement, in the six-month period following, there was an increase in both the number and the proportion of abortions being performed in the second trimester. So by delaying women's access to abortion, these requirements are actually increasing the risks that women face.”</p><cite>— Stephanie Toti, advocate for Whole Woman's Health</cite></blockquote>
          </aside>
          <aside class="aside-container aside_audio inactive" data-aside="oral-argument-2">
            ...
            <blockquote><p>“And I think, therefore, that if you do find that this law is upheld, what you will be saying is that this right really only exists in theory and not in fact, going forward, and that the commitments that this Court made in <em>Casey</em> will not have been kept.”</p><cite>— Solicitor General Donald V. Verrilli, amicus curiae for the United States</cite></blockquote>
          </aside>
        </div>
        ...
        <div class="aside-wrap">
          ...
          <aside class="aside-container aside_audio inactive" data-aside="oral-argument-3">
            ...
            <blockquote><p>“But what is the legitimate interest in protecting their health? What evidence is there that under the prior law, the prior law was not sufficiently protective of the women's health? As I understand it, this is one of the lowest-risk procedures, and you give a horrible from Pennsylvania, but absolutely nothing from Texas. As far as we know, this is among the most safe, the least risk procedures, an early-stage abortion. So what was -- what was the problem that the legislature was responding to that it needed to improve the facilities for women's health?”</p><cite>— Justice Ruth Bader Ginsburg</cite></blockquote>
          </aside>
      ...
      <section id="ch4-6">
        <h3><span class="sub-chapter-numeral">4.6</span>What could the decision say?</h3>

        <p>Check back after the decision is released for our analysis. Until then, here are some potential outcomes.</p>

        <ul>
          <li>An equally divided Court votes 4-4, and the decision of the lower court is affirmed. If this is the outcome, the law remains in place, but no national precedent is set.</li>
          <li>The justices hold the case over to next term for reargument, so that it can be heard by a full bench.</li>
          <li>The Court remands the case to a lower court for further arguments or fact-finding, which could have the effect of delaying the Court’s say on the matter until there are nine justices.</li>
          <li>The Court rules for the petitioners (the abortion clinics), and overturns or limits HB2. There is a wide range of possible outcomes in this instance.</li>
          <li>The Court rules for the respondents (Texas), and HB2 stays in place and similar laws across the country are permissible.</li>
        </ul>

      </section>

      <section id="ch4-7">
        <h3><span class="sub-chapter-numeral">4.7</span>What did the dissent say?</h3>
        <p>Check back after the decision is released for our analysis.</p>
      </section>

      <section id="ch4-8">
        <h3><span class="sub-chapter-numeral">4.8</span>What implications does the decision have for similar laws in other states?</h3>
        <p>Check back after the decision is released for our analysis.</p>
      </section>
      ...
      <section id="ch4-9" class="video-section">
        ...
        <div class="video-wrapper">
          <video class="video" poster="template/video/schmidt.jpg" width="1920px" height="1072px" preload="auto" controls="controls" style="width:100%; height:100%;">
            ...
            <source type="video/mp4" src="template/video/Schmidt.mp4" />
            <!-- WebM/VP8 for Firefox4, Opera, and Chrome -->
            <source type="video/webm" src="template/video/Schmidt.webm" />
            <!-- Ogg/Vorbis for older Firefox and Opera versions -->
            <source type="video/ogg" src="template/video/Schmidt.ogv" />
          </video>
        </div>
      </section>
      ...
      <section id="ch4-quicktake">
        <h4>Quick take:</h4>
        <ul>
          <li>This is the first time a reproductive rights case has gone before a bench with three female justices. Most of the recent cases had had only one, while Justices Sandra Day O’Connor and Ruth Bader Ginsburg were both on the bench for <em>Carhart I</em>.</li>
          <li>A law similar to the Texas one was passed recently in Louisiana, and challengers appealed to the Supreme Court. After the Court heard arguments in <em>Whole Woman’s Health</em>, the justices put a stay on the Louisiana law and thus blocked its enforcement. While the Court’s inner workings are shrouded in mystery, this could be a sign that the Texas law may not stand as it is.</li>
        </ul>
      </section>

      <div class="chapter-nav">
        <div class="prev-container">
          <a href="/ch3" class="prev ajax">
