  ...
  <div class="sceneElement" data-viewport="1">
    ...
    <div class="page-content">
      ...
      <section id="ch2-7">
        ...
        <p>Chief Justice William H. Rehnquist wrote that abortion was not a constitutional right. He argued that Roe had been decided wrongly, and that overturning it would have been the correct course of action. He criticized the middle ground put forward in the majority opinion.</p>
      ...
      <section class="video-section">
        <video class="video" poster="template/video/heyman.jpg" width="1920px" height="1072px" preload="auto" controls="controls" style="width:100%; height:100%;">
          ...
          <source type="video/webm" src="template/video/Heyman.webm" />
          <!-- Ogg/Vorbis for older Firefox and Opera versions -->
          <source type="video/ogg" src="template/video/Heyman.ogv" />
        </video>
      </section>
      ...
      <div class="chapter-nav">
        <div class="prev-container">
          <a href="/ch1#ch1-1" class="prev ajax">
        ...
        <div class="next-container">
          <a href="/ch3#ch3-1" class="next ajax">
