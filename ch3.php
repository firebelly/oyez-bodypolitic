  ...
  <div class="sceneElement" data-viewport="2">
    ...
    <div class="page-content">
      ...
      <section id="ch3-6">
        ...
        <div class="aside-wrap">
          <p>A big issue was about the amount of deference that courts are supposed to give to Congressional findings regarding medical facts. If <span class="aside-trigger audio-trigger first-item" data-aside="oral-argument-1"><span class="notice-me"><svg class="icon icon-audio"><use xlink:href="#icon-audio"></use></svg></span>Congress says</span> that the D&X procedure is never medically necessary, but some members of the <span class="aside-trigger audio-trigger first-item" data-aside="oral-argument-2"><span class="notice-me"><svg class="icon icon-audio"><use xlink:href="#icon-audio"></use></svg></span>medical community</span> disagree, should courts defer to the findings of Congress or to the doctors? They also debated whether there was enough difference from <em>Carhart</em> I to rule <span class="aside-trigger audio-trigger first-item" data-aside="oral-argument-3"><span class="notice-me"><svg class="icon icon-audio"><use xlink:href="#icon-audio"></use></svg></span>differently</span>. (Plus there was an unusual <span class="aside-trigger audio-trigger first-item" data-aside="oral-argument-4"><span class="notice-me"><svg class="icon icon-audio"><use xlink:href="#icon-audio"></use></svg></span>outburst</span> from an observer in the courtroom.)</p>
      ...
      <section id="ch3-quicktake">
        ...
        <ul>
          <li>The decisions in the <em>Carhart</em> cases showed a lack of teeth in their decision in <em>Planned Parenthood v. Casey</em>. In essence, “undue burden” was a standard that was proving difficult to define.</li>
