  ...
  <div class="sceneElement" data-viewport="2">
    ...
    <div class="page-content">
      ...
      <section id="ch3-5">
        ...
        <div class="aside-wrap">
          <p>In 2003, the federal government passed the Partial-Birth Abortion Ban <span class="aside-trigger first-item" data-aside="abortion-plan-act"><span class="notice-me"><svg class="icon icon-info"><use xlink:href="#icon-info"></use></svg></span>Act</span>. The act banned any procedure in which the death of the fetus occurred once “<span class="aside-trigger first-item" data-aside="citation"><span class="notice-me"><svg class="icon icon-info"><use xlink:href="#icon-info"></use></svg></span>the</span> entire fetal head or any part of the fetal trunk past the navel is outside the body of the mother.” This meant that the D&X procedure would be outlawed nationwide. Dr. Carhart again led the case against the ban, arguing that it was unconstitutional under Roe, Casey, and Carhart I. His case again made it to the Supreme Court.</p>
      ...
      <div class="chapter-nav">
        <div class="prev-container">
          <a href="/ch2#ch2-1" class="prev ajax">
        ...
        <div class="next-container">
          <a href="/ch4#ch4-1" class="next ajax">
