...
<div class="wrap">
  <div class="sceneElement" data-viewport="2">
    <h2 class="visually-hidden">Ch 3 Gonzales V. Carhart</h2>
    <div class="page-content">
      ...
      <section id="ch3-3">
        ...
        <div class="aside-wrap">
          <p>In 1998, Dr. Carhart sued the state of Nebraska, challenging a law banning intact dilation and extraction (D&X), a common late-term abortion procedure. The procedure was referred to by some as “partial-birth abortion.” His case went to the Supreme Court as <a href="https://www.oyez.org/cases/1999/99-830" target="_blank"><em>Stenberg v. Carhart</em></a> (often referred to as <em>Carhart</em> I) in 2000. In this case, the Court ruled 5-4 that the Nebraska statute was unconstitutional under the standards set in <em>Roe</em> and <em>Casey</em>. Justice Stephen Breyer authored the opinion, which relied heavily on Dr. Carhart’s medical testimony that D&X was sometimes the safest method to terminate a late-term pregnancy and could be <span class="aside-trigger first-item" data-aside="opinion-quote-1"><span class="notice-me"><svg class="icon icon-info"><use xlink:href="#icon-info"></use></svg></span>medically necessary</span>. Justice Anthony Kennedy’s dissent criticized the majority’s reliance on <span class="aside-trigger first-item" data-aside="opinion-quote-2"><span class="notice-me"><svg class="icon icon-info"><use xlink:href="#icon-info"></use></svg></span>Dr. Carhart’s expertise</span>, and asserted that the majority opinion misrepresented the details of the D&X procedure.</p>
      ...
      <section id="ch3-4">
        <h3><span class="sub-chapter-numeral">3.4</span>How did the Court change between the two Carhart cases?</h3>

        <p>Justice Sandra Day O’Connor retired from the bench in 2006 and was succeeded by the more conservative Justice Samuel Alito. Justice Alito served on the United States Court of Appeals for the Third Circuit when it heard <em>Casey</em>, before it reached the Supreme Court, and he had written the opinion upholding the abortion restrictions in question in that case. Justice Alito was predictably in favor of restrictions placed on abortion.</p>

      </section>

      <section id="ch3-5">
        <h3><span class="sub-chapter-numeral">3.5</span>What was the law in question, and what was the case against it?</h3>

        <div class="aside-wrap">
          <p>In 2003, the federal government passed the Partial-Birth Abortion Ban <span class="aside-trigger first-item" data-aside="abortion-plan-act"><span class="notice-me"><svg class="icon icon-info"><use xlink:href="#icon-info"></use></svg></span>Act</span>. The act banned any procedure in which the death of the fetus occurred once <span class="aside-trigger first-item" data-aside="citation"><span class="notice-me"><svg class="icon icon-info"><use xlink:href="#icon-info"></use></svg></span></span>“the entire fetal head or any part of the fetal trunk past the navel is outside the body of the mother.” This meant that the D&X procedure would be outlawed nationwide. Dr. Carhart again led the case against the ban, arguing that it was unconstitutional under <em>Roe</em>, <em>Casey</em>, and <em>Carhart</em> I. His case again made it to the Supreme Court.</p>
          <aside class="aside-container aside_info inactive" data-aside="abortion-plan-act">
            <svg class="icon icon-info"><use xlink:href="#icon-info"></use></svg>
            <p>
              YEAs: 63<br>
              NAYs: 34<br>
          ...
          <aside class="aside-container aside_info inactive" data-aside="citation">
            <svg class="icon icon-info"><use xlink:href="#icon-info"></use></svg>
            <p>Citation: 18 U.S.C.A. § 153</p>
          </aside>
        </div>
      </section>

      <section id="ch3-6">
        <h3><span class="sub-chapter-numeral">3.6</span>What happened in oral arguments?</h3>

        <div class="aside-wrap">
          <p>A key issue at oral argument was the amount of deference that courts are supposed to give to Congressional findings regarding medical facts. If <span class="aside-trigger audio-trigger first-item" data-aside="oral-argument-1"><span class="notice-me"><svg class="icon icon-audio"><use xlink:href="#icon-audio"></use></svg></span>Congress says</span> that the D&X procedure is never medically necessary, but some members of the <span class="aside-trigger audio-trigger first-item" data-aside="oral-argument-2"><span class="notice-me"><svg class="icon icon-audio"><use xlink:href="#icon-audio"></use></svg></span>medical community</span> disagree, should courts defer to the findings of Congress or to the doctors? They also debated whether there was enough difference from <em>Carhart</em> I to rule <span class="aside-trigger audio-trigger first-item" data-aside="oral-argument-3"><span class="notice-me"><svg class="icon icon-audio"><use xlink:href="#icon-audio"></use></svg></span>differently</span>. (Plus there was an unusual <span class="aside-trigger audio-trigger first-item" data-aside="oral-argument-4"><span class="notice-me"><svg class="icon icon-audio"><use xlink:href="#icon-audio"></use></svg></span>outburst</span> from an observer in the courtroom.)</p>
      ...
      <section id="ch3-8">
        ...
        <div class="aside-wrap">
          <p>Justice Ruth Bader Ginsburg wrote the fiery dissent, which was joined by Justices John Paul Stevens, David Souter, and Stephen Breyer. She wrote that upholding the Act violated the precedent set by <em>Casey</em>, and that the statute must include a provision regarding the pregnant woman’s health, which was <span class="aside-trigger first-item" data-aside="opinion-quote-4"><span class="notice-me"><svg class="icon icon-info"><use xlink:href="#icon-info"></use></svg></span>absent</span>. In announcing her dissent from the bench, she criticized the majority opinion as infringing on <span class="aside-trigger audio-trigger first-item" data-aside="dissent-quote-1"><span class="notice-me"><svg class="icon icon-audio"><use xlink:href="#icon-audio"></use></svg></span>women’s rights</span>.</p>
      ...
      <section id="ch3-9">
        <h3><span class="sub-chapter-numeral">3.9</span>What happened next?</h3>

        <p>Overall, the decision sent a mixed message to the country about the Supreme Court’s position on abortion. The unique clash of morality, medicine, privacy, and women’s rights in each abortion case, plus different compositions of justices who heard each one, has led to different outcomes. The Court seemed willing to place limits on certain aspects of abortion, but would it overturn the right to abortion entirely? The answer remained unclear. In practical terms, only four doctors nationally perform late-term abortions today, a result of both the regulations and attempts on the lives of doctors who perform the procedure. </p>
      ...
      <section id="ch3-quicktake">
        ...
        <ul>
          <li>The decisions in the <em>Carhart</em> cases showed the difficulty of defining the "undue burden" test from <em>Planned Parenthood v. Casey</em>. Each side claimed to be applying the same test but came to opposite conclusions on the constitutionality of the federal law. In essence, “undue burden” was a standard that was proving difficult to define.</li>
          <li>One argument as to the change in doctrine between <em>Casey</em> and the <em>Carhart</em> cases - or even the difference between the <em>Carhart</em> cases - is that it was due more to the makeup of the Court rather than a shift in public opinion.</li>
        </ul>
      </section>
